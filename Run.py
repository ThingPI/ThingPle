#import sys
#sys.path.append('/home/pi/thingpi/People-Counting-in-Real-Time/mylib/centroidtracker.py')
...
def run():
   ...
   while True:
      ...
      for (i, (k, v)) in enumerate(info2):
         ...
         cv2.putText(frame, text, (15, H - ((i * 20) + 50)), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (255, 0, 0), 2) #Red
